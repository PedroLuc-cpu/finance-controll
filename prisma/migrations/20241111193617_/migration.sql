...
INSERT INTO "new_User" ("confirmedPassword", "createdAt", "email", "emailVerified", "id", "image", "isNotification", "lastResetAttempt", "name", "password", "passwordResetAttempts", "passwordResetCode", "passwordResetExpires", "updatedAt") SELECT "confirmedPassword", "createdAt", "email", "emailVerified", "id", "image", "isNotification", "lastResetAttempt", "name", "password", coalesce("passwordResetAttempts", 0) AS "passwordResetAttempts", "passwordResetCode", "passwordResetExpires", "updatedAt" FROM "User";
DROP TABLE "User";
